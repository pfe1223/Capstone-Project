...
Elm.Main.make = function (_elm) {
   ...
   "Import everything from the Text library. This\n",
   A2($Basics._op["++"],
   ...
   var title = function (f) {
      return $Text.centered($Text.height(50)($Text.color(darkerGreen)($Text.fromString(f))));
   };
   var backgroundColor = A3($Color.rgb,
   39,
   45,
   60);
   var dashPresent = $Graphics$Collage.filled(darkerBlue)(A2($Graphics$Collage.rect,
   20,
   5));
   var dashPast = $Graphics$Collage.alpha(0.5)($Graphics$Collage.filled(darkerBlue)(A2($Graphics$Collage.rect,
   20,
   5)));
   var wayfinderFuture = $Graphics$Collage.outlined($Graphics$Collage.solid(darkerBlue))($Graphics$Collage.circle(15));
   var wayfinderPresent = $Graphics$Collage.filled(darkerBlue)($Graphics$Collage.circle(15));
   var wayfindingWelcome = $Graphics$Element.color($Color.grey)(A3($Graphics$Element.container,
   400,
   50,
   ...
   _L.fromArray([A3($Graphics$Collage.collage,
                ...
                50,
                _L.fromArray([wayfinderFuture]))]))));
   var wayfinderPast = $Graphics$Collage.alpha(0.5)($Graphics$Collage.filled(darkerBlue)($Graphics$Collage.circle(15)));
   var wayfindingImports = $Graphics$Element.color($Color.grey)(A3($Graphics$Element.container,
   400,
   50,
   $Graphics$Element.middle)(A2($Graphics$Element.flow,
   $Graphics$Element.right,
   _L.fromArray([A3($Graphics$Collage.collage,
                ...
                50,
                _L.fromArray([wayfinderFuture]))]))));
   var wayfindingSignals = $Graphics$Element.color($Color.grey)(A3($Graphics$Element.container,
   400,
   50,
   $Graphics$Element.middle)(A2($Graphics$Element.flow,
   $Graphics$Element.right,
   _L.fromArray([A3($Graphics$Collage.collage,
                ...
                50,
                _L.fromArray([wayfinderFuture]))]))));
   var wayfindingModel = $Graphics$Element.color($Color.grey)(A3($Graphics$Element.container,
   400,
   50,
   $Graphics$Element.middle)(A2($Graphics$Element.flow,
   $Graphics$Element.right,
   _L.fromArray([A3($Graphics$Collage.collage,
                ...
                50,
                _L.fromArray([wayfinderFuture]))]))));
   var wayfindingUpdate = $Graphics$Element.color($Color.grey)(A3($Graphics$Element.container,
   400,
   50,
   $Graphics$Element.middle)(A2($Graphics$Element.flow,
   $Graphics$Element.right,
   _L.fromArray([A3($Graphics$Collage.collage,
                ...
                50,
                _L.fromArray([wayfinderFuture]))]))));
   var wayfindingView = $Graphics$Element.color($Color.grey)(A3($Graphics$Element.container,
   400,
   50,
   $Graphics$Element.middle)(A2($Graphics$Element.flow,
   $Graphics$Element.right,
   _L.fromArray([A3($Graphics$Collage.collage,
                ...
                50,
                _L.fromArray([wayfinderFuture]))]))));
   var wayfindingCongrats = $Graphics$Element.color($Color.grey)(A3($Graphics$Element.container,
   400,
   50,
   $Graphics$Element.middle)(A2($Graphics$Element.flow,
   $Graphics$Element.right,
   ...
   var codeElement = function (gameCode) {
      return $Graphics$Element.color($Color.grey)(A4($Graphics$Element.container,
      containerWidth,
      gameHeight,
   ...
   var letsGo = function (sig) {
      return A2($Graphics$Element.size,
      100,
      40)($Graphics$Element.color($Color.grey)(A2($Graphics$Input.button,
   ...
   var importsWelcome = F2(function (_v0,
   sig) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
         ...
         _U.badCase($moduleName,
         "between lines 330 and 336");
      }();
   });
   var displayImports = F3(function (_v4,
   sig,
   hoveredOn) {
      return function () {
         switch (_v4.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingImports)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 392 and 399");
      }();
   });
   var signalsWelcome = F2(function (_v8,
   sig) {
      return function () {
         switch (_v8.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingSignals)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 491 and 497");
      }();
   });
   var displaySignals1 = F3(function (_v12,
   sig,
   hoveredOn) {
      return function () {
         switch (_v12.ctor)
   ...
   var displaySignals2 = F3(function (_v16,
   sig,
   hoveredOn) {
      return function () {
         switch (_v16.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingSignals)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 603 and 610");
      }();
   });
   var displaySignals3 = F3(function (_v20,
   sig,
   hoveredOn) {
      return function () {
         switch (_v20.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingSignals)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 649 and 656");
      }();
   });
   var displaySignals4 = F3(function (_v24,
   sig,
   hoveredOn) {
      return function () {
         switch (_v24.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingSignals)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 689 and 696");
      }();
   });
   var modelWelcome = F2(function (_v28,
   sig) {
      return function () {
         switch (_v28.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingModel)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 805 and 811");
      }();
   });
   var displayModel1 = F3(function (_v32,
   sig,
   hoveredOn) {
      return function () {
         switch (_v32.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingModel)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 869 and 876");
      }();
   });
   var displayModel2 = F3(function (_v36,
   sig,
   hoveredOn) {
      return function () {
         switch (_v36.ctor)
   ...
   var displayModel3 = F3(function (_v40,
   sig,
   hoveredOn) {
      return function () {
         switch (_v40.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingModel)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 929 and 936");
      }();
   });
   var displayModel4 = F3(function (_v44,
   sig,
   hoveredOn) {
      return function () {
         switch (_v44.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingModel)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 969 and 976");
      }();
   });
   var displayModel5 = F3(function (_v48,
   sig,
   hoveredOn) {
      return function () {
         switch (_v48.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingModel)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1009 and 1016");
      }();
   });
   var displayModel6 = F3(function (_v52,
   sig,
   hoveredOn) {
      return function () {
         switch (_v52.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingModel)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1058 and 1065");
      }();
   });
   var displayModel7 = F3(function (_v56,
   sig,
   hoveredOn) {
      return function () {
         switch (_v56.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingModel)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1151 and 1158");
      }();
   });
   var updateWelcome = F2(function (_v60,
   sig) {
      return function () {
         switch (_v60.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingUpdate
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1241 and 1247");
      }();
   });
   var displayUpdate1 = F3(function (_v64,
   sig,
   hoveredOn) {
      return function () {
         switch (_v64.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1303 and 1310");
      }();
   });
   var displayUpdate2 = F3(function (_v68,
   sig,
   hoveredOn) {
      return function () {
         switch (_v68.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1373 and 1380");
      }();
   });
   var displayUpdate3 = F3(function (_v72,
   sig,
   hoveredOn) {
      return function () {
         switch (_v72.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1439 and 1446");
      }();
   });
   var displayUpdate4 = F3(function (_v76,
   sig,
   hoveredOn) {
      return function () {
         switch (_v76.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1516 and 1523");
      }();
   });
   var displayUpdate5 = F3(function (_v80,
   sig,
   hoveredOn) {
      return function () {
         switch (_v80.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1616 and 1623");
      }();
   });
   var displayUpdate6 = F3(function (_v84,
   sig,
   hoveredOn) {
      return function () {
         switch (_v84.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1669 and 1676");
      }();
   });
   var displayUpdate7 = F3(function (_v88,
   sig,
   hoveredOn) {
      return function () {
         switch (_v88.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1801 and 1808");
      }();
   });
   var displayUpdate8 = F3(function (_v92,
   sig,
   hoveredOn) {
      return function () {
         switch (_v92.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1903 and 1910");
      }();
   });
   var displayUpdate9 = F3(function (_v96,
   sig,
   hoveredOn) {
      return function () {
         switch (_v96.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 1946 and 1953");
      }();
   });
   var displayUpdate10 = F3(function (_v100,
   sig,
   hoveredOn) {
      return function () {
         switch (_v100.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2043 and 2050");
      }();
   });
   var displayUpdate11 = F3(function (_v104,
   sig,
   hoveredOn) {
      return function () {
         switch (_v104.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2154 and 2161");
      }();
   });
   var displayUpdate12 = F3(function (_v108,
   sig,
   hoveredOn) {
      return function () {
         switch (_v108.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2228 and 2235");
      }();
   });
   var displayUpdate13 = F3(function (_v112,
   sig,
   hoveredOn) {
      return function () {
         switch (_v112.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2273 and 2280");
      }();
   });
   var displayUpdate14 = F3(function (_v116,
   sig,
   hoveredOn) {
      return function () {
         switch (_v116.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingUpdate)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2322 and 2329");
      }();
   });
   var viewWelcome = F2(function (_v120,
   sig) {
      return function () {
         switch (_v120.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2395 and 2401");
      }();
   });
   var displayView1 = F3(function (_v124,
   sig,
   hoveredOn) {
      return function () {
         switch (_v124.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2458 and 2465");
      }();
   });
   var displayView2 = F3(function (_v128,
   sig,
   hoveredOn) {
      return function () {
         switch (_v128.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2493 and 2500");
      }();
   });
   var displayView3 = F3(function (_v132,
   sig,
   hoveredOn) {
      return function () {
         switch (_v132.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2544 and 2551");
      }();
   });
   var displayView4 = F3(function (_v136,
   sig,
   hoveredOn) {
      return function () {
         switch (_v136.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2600 and 2607");
      }();
   });
   var displayView5 = F3(function (_v140,
   sig,
   hoveredOn) {
      return function () {
         switch (_v140.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2641 and 2648");
      }();
   });
   var displayView6 = F3(function (_v144,
   sig,
   hoveredOn) {
      return function () {
         switch (_v144.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2695 and 2702");
      }();
   });
   var displayView7 = F3(function (_v148,
   sig,
   hoveredOn) {
      return function () {
         switch (_v148.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2749 and 2756");
      }();
   });
   var displayView8 = F3(function (_v152,
   sig,
   hoveredOn) {
      return function () {
         switch (_v152.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2792 and 2799");
      }();
   });
   var displayView9 = F3(function (_v156,
   sig,
   hoveredOn) {
      return function () {
         switch (_v156.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2860 and 2867");
      }();
   });
   var displayView10 = F3(function (_v160,
   sig,
   hoveredOn) {
      return function () {
         switch (_v160.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2910 and 2917");
      }();
   });
   var displayView11 = F3(function (_v164,
   sig,
   hoveredOn) {
      return function () {
         switch (_v164.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingView)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 2955 and 2962");
      }();
   });
   var congrats = F2(function (_v168,
   sig) {
      return function () {
         switch (_v168.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingCongrats)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 3000 and 3006");
      }();
   });
   var idea1 = F2(function (_v172,
   sig) {
      return function () {
         switch (_v172.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingCongrats)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 3059 and 3065");
      }();
   });
   var idea2 = F2(function (_v176,
   sig) {
      return function () {
         switch (_v176.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingCongrats)
                           ...
                           ,buttonsLRElement(sig)]))));}
         _U.badCase($moduleName,
         "between lines 3088 and 3094");
      }();
   });
   var idea3 = F2(function (_v180,
   sig) {
      return function () {
         switch (_v180.ctor)
         {case "_Tuple2":
   ...
   var displayWelcome = F2(function (_v184,
   sig) {
      return function () {
         switch (_v184.ctor)
         {case "_Tuple2":
   ...
   var elmResources = F2(function (_v188,
   sig) {
      return function () {
         switch (_v188.ctor)
         {case "_Tuple2":
            return A2($Graphics$Element.color,
              ...
              _L.fromArray([wayfindingElement(wayfindingCongrats)
                           ...
                           ,$Graphics$Element.color($Color.grey)(A4($Graphics$Element.container,
                           containerWidth,
                           285,
                           $Graphics$Element.middle,
                           A2($Graphics$Element.flow,
      ...
      return function () {
         ...
         {case "_Tuple2":
            return _U.eq(sig,
              ...
              ,_1: _v192._1},
              sig) : _U.eq(sig,
              4) ? A3(displaySignals1,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              5) ? A3(displaySignals2,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              6) ? A3(displaySignals3,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              7) ? A3(displaySignals4,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              ...
              ,_1: _v192._1},
              sig) : _U.eq(sig,
              17) ? A3(displayUpdate1,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              18) ? A3(displayUpdate2,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              19) ? A3(displayUpdate3,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              20) ? A3(displayUpdate4,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              21) ? A3(displayUpdate5,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              22) ? A3(displayUpdate6,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              23) ? A3(displayUpdate7,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              24) ? A3(displayUpdate8,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              25) ? A3(displayUpdate9,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              26) ? A3(displayUpdate10,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              27) ? A3(displayUpdate11,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              28) ? A3(displayUpdate12,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              29) ? A3(displayUpdate13,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              hoveredOn) : _U.eq(sig,
              30) ? A3(displayUpdate14,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig,
              ...
              ,_0: _v192._0
              ,_1: _v192._1},
              sig) : _U.eq(sig,44) ? A2(idea1,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig) : _U.eq(sig,45) ? A2(idea2,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig) : _U.eq(sig,46) ? A2(idea3,
              {ctor: "_Tuple2"
              ,_0: _v192._0
              ,_1: _v192._1},
              sig) : _U.eq(sig,
